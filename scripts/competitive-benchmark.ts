...
const output = {
  ...
  capabilityMatrix: [
    ...
    { capability: 'real skinned LOD1 plus dimension/bone/body-overlap collision audit and exact GLB manifest preservation', img2threejs: 'not established in pinned audit', morphloom: domainProof.game?.pass ? 'yes' : 'blocked' },
