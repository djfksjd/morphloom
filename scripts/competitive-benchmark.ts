...
const output = {
  ...
  capabilityMatrix: [
    ...
    { capability: 'per-joint weighted deformation, motion/loop/root-motion checks, and exact GLB animation-metadata preservation', img2threejs: 'not established in pinned core audit', morphloom: domainProof.animation?.pass ? '10/10 bilateral shoulder, elbow, hip, knee, and ankle joints measured' : 'blocked' },
