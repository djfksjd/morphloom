...
| 캐릭터 | 실제 49-bone 스켈레톤(30개 손가락 본)·손 형상 기반 스킨 웨이트·4개 GLB 애니메이션 트랙·스킨 LOD1·충돌 프리미티브를 가진 인체 베이스 · 포즈 기반 Web Hero |
...
| 애니메이션 | 99 | 49본 스켈레톤 · 정규화 웨이트 · 관절 변형 실측 · 실제 손가락 웨이트/트랙 · GLB 재열기 |
