...
|---|---:|---|
| 산업디자인 | 99 | 폐쇄 토폴로지 · 근거 치수 월드좌표 재실측 · 유한/비퇴화 UV · 단위 노멀 · 75% 이상 PBR 미세표면 · 근거 |
