...
| 자동 테스트 폭 | 코어 1,083개 실행 확인 | 130개—개수보다 납품 계약 회귀·빈 동작/루프 단절·표면 스케일 위장·다중 시점 불일치·암시적 곡면 결함·거짓 우위 차단에 집중 |
