...
| OBJ/STL/PLY 실제 정적 메시 납품 | 고정 커밋 감사에서 확인되지 않음 | 브라우저 재열기 + Blender 5.2.1 임포트, 81,768 tris 일치, 포락 오차 0.001mm 이하 |
...
| 자동 테스트 폭 | 코어 1,083개 실행 확인 | 214개—개수보다 납품 계약 회귀와 중립 렌더의 카메라·조명·정규화·같은 GLB·실제 파일 해시 위조 차단에 집중 |
