...
| 게임 LOD·충돌·예산·UV·노멀 게이트 | 고정 커밋 감사에서 확인되지 않음 | 지원—실제 스킨 LOD0/1·충돌체 치수/본/바디 교차/높이 커버·GLB 충돌 지문·유한/비퇴화 UV·단위 노멀 검사 |
| 3D 프린팅 mm·폐쇄 체적·최소 형상·45° 오버행 | 고정 커밋 감사에서 확인되지 않음 | 지원 |
| 자동 테스트 폭 | 코어 1,083개 실행 확인 | 145개—개수보다 납품 계약 회귀·오목 다각형 건축 평면 반전/공백 침범·가짜 충돌체·UV/노멀 위장·브라우저 검증 중복/경쟁·빈 동작/루프 단절·표면 스케일 위장·다중 시점 불일치·암시적 곡면 결함·거짓 우위 차단에 집중 |
