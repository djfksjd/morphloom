...
| Blender 앱 자체 임포트·재내보내기·재임포트 | 공개 자동 증명 없음 | Blender 4.5.11 LTS에서 건축·산업디자인·전자 조립·애니메이션/게임·3D 프린팅 표면 5/5 통과 |
...
| 자동 테스트 폭 | 코어 1,083개 실행 확인 | 174개—개수보다 납품 계약 회귀·손상/경고 GLB 공식 규격 차단·오목 다각형 건축 평면 반전/공백 침범·가짜 LOD/충돌체·UV/노멀 위장·브라우저 검증 중복/경쟁·빈 동작/루프 단절·표면 스케일 위장·다중 시점 불일치·암시적 곡면 결함·위험한 de-light 증거·거짓 우위 차단에 집중 |
