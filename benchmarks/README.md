...
`npm run benchmark` measures properties that can be reproduced from geometry: triangles, named parts, category coverage, watertight components, boundary/non-manifold edges, degenerate triangles, and declared modeling operations.
